// ============================================
// KARIN OZTURK - PORTFOLIO SCRIPTS
...
function initScrollAnimations() {
    ...
    const animateElements = document.querySelectorAll(
        '.research-card, .project-card, .skill-category, .timeline-item, .contact-card'
    );
...
I'm passionate about NLP and building intelligent systems.

Let's connect:
📧 karin23@terpmail.umd.edu
🔗 github.com/karinozturk
